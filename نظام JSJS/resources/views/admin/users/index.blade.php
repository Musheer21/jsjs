...
<body>
    ...
    <div class="container">
        ...
        <div class="stats-row">
            <div class="stat-card">
                <div class="stat-icon" style="background: linear-gradient(135deg, #1565c0, #1976d2);">
            ...
            <div class="stat-card">
                ...
                <div class="stat-info">
                    <h4>آخر مستخدم مضاف</h4>
                    <h2 style="font-size: 1rem;">{{ $users->last() ? $users->last()->name : 'لا يوجد' }}</h2>
                </div>
            </div>
            <div class="stat-card">
                ...
                <div class="stat-info">
                    <h4>حالة النظام</h4>
                    <h2 style="font-size: 1rem; color: var(--success);">نشط</h2>
                </div>
            </div>
        </div>
        ...
        <div class="header-actions">
            <h3>
                <span class="material-icons" style="color: var(--accent);">manage_accounts</span>
                إدارة المستخدمين
            </h3>
